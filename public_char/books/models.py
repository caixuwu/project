...
class User(models.Model):
    ...
    sex = models.BooleanField(verbose_name=u"性别")
...
class VerifyEmail(models.Model):
    ...
    # send_type = models.CharField(max_length=20,blank=True, null=True,) #可拓展用
    email = models.EmailField()
    gq_time = models.DateTimeField()
    is_user = models.BooleanField(default='no')
